...
const SwitchInput = ({inputId, inputName, labelText, required, onChange}) => {
  return (
      ...
      <div className="form-group col-sm-8 col-xs-7">
        <div className="checkbox">
          <label className="boolean optional" htmlFor={inputId}>
            <input className="boolean optional" type="checkbox" name={inputName} id={inputId} onChange={onChange} />
